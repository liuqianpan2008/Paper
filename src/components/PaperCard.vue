<template>
  <n-card title="投纸" >  
    <n-form :show-require-mark="false" :model="paperCard" :rules="rules" ref="paperCardRef">
      <n-form-item label="纸片标题" path="title">
           <n-input  placeholder="输入纸片标题" v-model:value="paperCard.title" maxlength="50" show-count />
      </n-form-item>
